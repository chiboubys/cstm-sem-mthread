...
#include "mthread_extra.h"
    ...
    // ADD : definition of semphore structure
    struct mthread_sem_s {
        mthread_tst_t lock; // used by the spinlock
        mthread_tst_t value; // actual value of the semaphore
        unsigned int max; // maximal value of the semaphore
    };
